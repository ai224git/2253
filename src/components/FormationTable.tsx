        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              <th 
                scope="col" 
                className="w-[20%] px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition"
                onClick={() => handleSortClick('etablissement')}
              >
                <div className="transform -rotate-45 origin-left h-16 flex items-end">
                  <span>Établissement {getSortIcon('etablissement')}</span>
                </div>
              </th>
              <th 
                scope="col" 
                className="w-[50%] px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition"
